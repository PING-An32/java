...
![image-20240703192220603](C:\Users\Lenovo\Desktop\八股\Java八股整理.assets\Java八股整理.assets\image-20240703192220603.png)

![image-20240703192146346](C:\Users\Lenovo\Desktop\八股\Java八股整理.assets\Java八股整理.assets\image-20240703192146346.png)
...
- 栈帧包括：
  ...
  - 动态链接：方法调用时用到。（动态链接又称为指向运行时常量池的方法引用）
    ...
    ![img](C:\Users\Lenovo\Desktop\八股\Java八股整理.assets\Java八股整理.assets\jvmimage-20220331175738692.png)
...
![image-20240703154509761](C:\Users\Lenovo\Desktop\八股\Java八股整理.assets\Java八股整理.assets\image-20240703154509761.png)
...
![image-20240703165221566](C:\Users\Lenovo\Desktop\八股\Java八股整理.assets\Java八股整理.assets\image-20240703165221566.png)
...
- 类中声明的基本数据类型变量是成员变量，放在堆中。（jdk8开始类的静态变量在堆中==class的尾部==，对象实例数据里；而jdk8之前静态变量在方法区）
...
一个对象的GC年龄，是存储在对象头里面的，一个Java对象在JVM内存中的布局由三个部分组成，分别是**对象头、实例数据、对齐填充**。而对象头里面有**4个bit位**来存储GC年龄。
...
3. **准备**
   ...
   - jdk6静态变量存放于instanceKlass末尾，jdk7和8静态变量转移到堆中java_mirror末尾存储
